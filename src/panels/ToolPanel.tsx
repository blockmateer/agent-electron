...
export function AllToolsPanel() {
  ...
  const entries: ToolEntry[] = [
    ...
    { id: "convert", label: "Export & convert", icon: <FileImage size={18} />, color: "#eb1000", needsDoc: false, run: open("convert") },
    { id: "images", label: "Create PDF from images", icon: <ImagePlus size={18} />, color: "#e5343a", needsDoc: false, run: () => createPdfFromImages() },
    { id: "export", label: "Export pages as images", icon: <FileImage size={18} />, color: "#eb1000", needsDoc: true, run: (id) => id && exportPagesAsImages(id, "png", 150) },
